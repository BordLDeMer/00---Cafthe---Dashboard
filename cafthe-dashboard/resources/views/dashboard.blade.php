            ...
            <div class="col-12 text-center mb-4">
                ...
                @if($produitsFaibleStock->isNotEmpty())
                    <p style="color: red; font-weight: bold; margin-top: 10px;">
                        ⚠️ Attention : {{ $produitsFaibleStock->count() }} produit(s) en rupture de stock !
                    </p>
                @endif
            </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped table-hover">
                                ...
                                <tbody>
                                @forelse($produitsFaibleStock as $produit)
                                    <tr style="background-color: #f8f9fa;"">
                                        <td style="color: #5a3e2b;">{{ $produit->designation_produit }}</td>
                                        <td style="color: #5a3e2b;">{{ $produit->stock }}</td>
                                        <td style="color: #5a3e2b;">{{ number_format($produit->prix_ttc, 2, ',', ' ') }} €</td>
                                        <td>
                                            <a href="{{ route('produits.edit', $produit) }}" class="btn btn-sm" style="background-color: #5a3e2b; color: white;">Modifier</a>
                                        </td>
                                    </tr>
                                @empty
                                    <tr>
