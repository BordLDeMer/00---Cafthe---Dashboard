    ...
    <div class="container-fluid py-4" style="background-color: #f8f9fa;">
        <div class="row justify-content-center">
            ...
            <div class="col-12 mb-4 d-flex justify-content-between">
                ...
                <form action="<?php echo e(route('panier.vider')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                        ...
                        <div class="card-body p-0">
                            <div class="table-responsive">
                                <table class="table table-striped mb-0" style="background-color: white; width: 100%;">
                                    ...
                                    <tbody>
                                    <?php $__currentLoopData = $panier; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $details): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            <td style="padding: 12px; text-align: center;">
                                                <div class="d-flex align-items-center justify-content-center">
                                                    <?php if(isset($details['image'])): ?>
                                                        <img src="<?php echo e(asset('storage/' . $details['image'])); ?>" alt="<?php echo e($details['designation_produit'] ?? 'Produit'); ?>" style="width: 50px; height: 50px; object-fit: cover; margin-right: 10px;">
                                                    <?php endif; ?>
                                                    <?php echo e($details['designation_produit'] ?? 'Produit inconnu'); ?>

                                                </div>
                                            </td>
                                            <td style="padding: 12px; text-align: center;"><?php echo e(number_format($details['prix_ttc'] ?? 0, 2)); ?> €</td>
                                            <td style="padding: 12px; text-align: center;">
                                                <form action="<?php echo e(route('panier.mettre_a_jour', $id)); ?>" method="POST" class="d-flex justify-content-center align-items-center">
                                                    <?php echo csrf_field(); ?>
                                                    <input type="number" name="quantite" value="<?php echo e($details['quantite'] ?? 1); ?>" min="1" style="width: 60px; text-align: center; border-radius: 5px; border: 1px solid #5a3e2b; padding: 5px;">
                                            ...
                                            <td style="padding: 12px; text-align: center;"><?php echo e(number_format(($details['prix_ttc'] ?? 0) * ($details['quantite'] ?? 1), 2)); ?> €</td>
                                            <td style="padding: 12px; text-align: center;">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\benjamin.bidou\00---Cafthe---Dashboard\cafthe-dashboard\resources\views/panier/voir.blade.php ENDPATH**/ ?>