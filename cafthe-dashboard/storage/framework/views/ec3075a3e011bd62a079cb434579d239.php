...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="row mb-3">
                                <label for="mdp" class="col-md-4 col-form-label text-md-end"><?php echo e(__('Password')); ?></label>
                                <div class="col-md-6">
...
unset($__errorArgs, $__bag); ?>" name="mdp" required autocomplete="current-password">
                                    <?php $__errorArgs = ['mdp'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
