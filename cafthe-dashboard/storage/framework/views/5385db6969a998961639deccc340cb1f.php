            ...
            <div class="col-md-120 mx-auto">
                <div class="card shadow" style="background-color: #ccbba7; border: none; border-radius: 10px; overflow: hidden; width: 100%;">
                    ...
                    <div class="card-body" style="background-color: white; color: #5a3e2b; padding: 20px;">
                        <form action="<?php echo e(route('vendeurs.mettre_a_jour_mon_profil')); ?>" method="POST">
                            <?php echo csrf_field(); ?>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-8">
                                    <input type="text" class="form-control" id="nom_prenom" name="nom_prenom" value="<?php echo e(old('nom_prenom', $vendeur->nom_prenom)); ?>" required>
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="col-md-4" style="white-space: nowrap;">
                                ...
                                <div class="col-md-8">
                                    <input type="text" class="form-control" id="tel" name="tel" value="<?php echo e(old('tel', $vendeur->tel)); ?>" required>
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="col-md-4" style="white-space: nowrap;">
                                ...
                                <div class="col-md-8">
                                    <input type="email" class="form-control" id="mail" name="mail" value="<?php echo e(old('mail', $vendeur->mail)); ?>" required>
                                </div>
                            </div>
                            <div class="row mb-3">
                            ...
                            <div class="d-flex justify-content-end mt-4">
                                <a href="<?php echo e(route('vendeurs.mon_profil')); ?>" class="btn me-2" style="background-color: #6c757d; color: white; border-radius: 5px; padding: 8px 15px;">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\benjamin.bidou\00---Cafthe---Dashboard\cafthe-dashboard\resources\views/vendeurs/edit_mon_profil.blade.php ENDPATH**/ ?>