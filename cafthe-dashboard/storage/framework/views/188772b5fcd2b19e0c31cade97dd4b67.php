            ...
            <div class="col-12 mb-4">
                <form action="<?php echo e(route('clients.index')); ?>" method="GET" class="d-flex justify-content-center">
                    <div class="input-group" style="max-width: 500px; width: 100%;">
                        ...
                        <a href="<?php echo e(route('clients.create')); ?>" class="btn" style="background-color: #82c46c; color: white; border-radius: 10px; padding: 8px 20px; margin-left: 10px; text-decoration: none;">
                            Ajouter un client
                        </a>
                    </div>
                </form>
