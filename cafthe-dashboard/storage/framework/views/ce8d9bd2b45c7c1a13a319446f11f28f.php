                ...
                <div class="card shadow" style="background-color: #ccbba7; border: none; border-radius: 10px; overflow: hidden; width: 100%;">
                    ...
                    <div class="card-footer" style="background-color: #e9ecef; border: none; border-radius: 0 0 10px 10px !important;">
                        <div class="d-flex justify-content-between">
                            <a href="<?php echo e(route('clients.edit', $client->ID_client)); ?>" class="btn" style="background-color: #8b7355; color: white; border-radius: 5px; padding: 8px 15px; text-decoration: none;">
                                <i class="fas fa-edit"></i> Modifier
                            </a>
                            <a href="<?php echo e(route('clients.index')); ?>" class="btn" style="background-color: #5a3e2b; color: white; border-radius: 5px; padding: 8px 15px; text-decoration: none;">
