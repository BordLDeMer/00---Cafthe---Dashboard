...
<?php if($produit): ?>
    <div class="product-card">
        <div class="product-card-header">
            <h3 class="product-card-title"><?php echo e($produit->designation_produit); ?></h3>
        </div>
        ...
        <div class="product-card-body">
            ...
            <p><strong>Ventes :</strong> <?php echo e($produit->ventes); ?></p>
            <?php if(!empty($produit->description)): ?>
                <p class="product-card-description">
                    <?php echo e(Str::limit($produit->description, 100)); ?>
        ...
        <div class="product-card-footer">
            <div class="product-card-price">
                <?php echo e(number_format($produit->prix_ttc, 2, ',', ' ')); ?> €
            </div>
...
<?php /**PATH C:\Users\benjamin.bidou\00---Cafthe---Dashboard\cafthe-dashboard\resources\views/product-card.blade.php ENDPATH**/ ?>